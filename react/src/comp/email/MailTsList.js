                                    ...
                                    <table className="table table-hover">
                                        ...
                                        <tbody>
                                            ...
                                            <tr key={mail.mail_no}>
                                                ...
                                                <td><Link to={`/email/gettsmail/${mail.mailts_no}`} onClick={handleLinkClick}>{mail.mailts_title}</Link></td>
                                                <td>{formatDate(mail.mailts_regdate)}</td>
