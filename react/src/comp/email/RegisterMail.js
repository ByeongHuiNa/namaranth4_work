...
const RegisterMail = () =>{
    ...
    const handleQuillChange = (content) => {
        setMailContent(content); // React 상태를 업데이트
      };
    ...
    useEffect(() => {
        ...
        console.log('mailTitle 변경:', mail_title);
        console.log('receiverNo 변경:', receiver_no);
        console.log('mailContent 변경:', mail_content);
    
        // 예: 변경된 값을 이용한 화면 갱신 또는 서버로 데이터 전송 등의 로직을 추가할 수 있습니다.
    
      }, [user_no, mail_title, receiver_no, mail_content]); 
                            ...
                            <div className="row align-items-center">
                                <div className="col-md-12">
                                    ...
                                    <ul className="breadcrumb">
                                        ...
                                        <li className="breadcrumb-item"><a href="#!">E-Mail</a></li>
                            ...
                            <div className="col-sm-12">
                                <div className="card" style={{height:"600px"}}>
                                    ...
                                    <div className="card-body" >
                                        ...
                                        <h5>제목<input type="text" value={mail_title}  onChange={(e) => setMailTitle(e.target.value)} style={{ marginLeft: '35px' }} /> </h5>
